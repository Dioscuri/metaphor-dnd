...
function MonsterQuery() {
    ...
    function querySubmit(){
        ...
        const query = "I need a stories about " + query_input + ", monsters from stories and myths"
    ...
    function summarize(url, id){
        ...
        fetch('https://api.meaningcloud.com/summarization-1.0', summarizerOptions)
            ...
            .then( summary_response =>{
                let object = {}
                if (summary_response.summary == "" || summary_response.status.code == "212"){
                    object[id] = "Cannot Summarize"
                }
                else {object[id] = summary_response.summary}
    ...
    return (
      <div className="query-section">
            <h3>Existing Monsters & Creatures Search</h3>
            <p> 
                Search for existing mythical monsters and creatures as inspiration for creatures in your next adventure. 
                For your prompt, input the type of monster you'd like to find for your reference.
            </p>
            ...
            <div className="query-input-section">
                ...
                />
                <button onClick={querySubmit}>Mythical Monsters Search</button>
            </div>
